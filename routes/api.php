...
// связка с онлайн пбх
Route::post('/calendarCall/onlinepbxInbound', 'PbxController@onlinepbxInbound');
Route::get('/calendarCall/onlinepbxOutbound', 'PbxController@onlinepbxOutbound');
Route::get('/calendarCall/onlinepbxDownload', 'PbxController@onlinepbxDownload');
Route::get('/calendarCall/onlinepbxNotifications', 'PbxController@onlinepbxNotifications');
