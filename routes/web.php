...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('guideTransport', 'GuideTransportController@index')->name('guideTransport.index');
        //->middleware('permission:settings.genindexeral');

    Route::get('guideTransport/create', 'GuideTransportController@create')->name('guideTransport.create');
    Route::post('guideTransport/store', 'GuideTransportController@store')->name('guideTransport.store');
    Route::put('guideTransport/{guideTransport}/update', 'GuideTransportController@update')->name('guideTransport.update');
    Route::get('guideTransport/{guideTransport}/edit', 'GuideTransportController@edit')->name('guideTransport.edit');
    Route::delete('guideTransport/{guideTransport}/destroy', 'GuideTransportController@destroy')->name('guideTransport.destroy');


    // сводная финансов транспорта
    Route::get('financeDelivery', 'FinanceDeliveryController@index')->name('financeDelivery.index');

});

Route::get('calendarDelivery', 'DeliveryController@index')->name('calendarDelivery.index');
Route::get('calendarDelivery/all', 'DeliveryController@calendarAjax')->name('calendarDelivery.All');
Route::post('calendarDelivery/action', 'DeliveryController@action')->name('calendarDelivery.action');
Route::get('calendarDelivery/select', 'DeliveryController@select')->name('calendarDelivery.select');
Route::get('calendarDelivery/calculator', 'DeliveryController@calculator')->name('calendarDelivery.calculator');


Route::get('calendarCall', 'CallController@index')->name('calendarCall.index');
Route::get('calendarCall/all', 'CallController@calendarAjax')->name('calendarCall.All');
Route::post('calendarCall/action', 'CallController@action')->name('calendarCall.action');
Route::get('calendarCall/select', 'CallController@select')->name('calendarCall.select');
Route::get('calendarCall/refetch', 'CallController@refetch')->name('calendarCall.refetch');
//Route::get('calendarCall/calculator', 'CallController@calculator')->name('calendarCall.calculator');
