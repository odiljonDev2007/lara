...
class VanguardServiceProvider extends BaseVanguardServiceProvider
{
    ...
    protected function plugins(): array
    {
        return [
            ...
            \Vanguard\Support\Plugins\Delivery::class,
            \Vanguard\Support\Plugins\Call::class,
            \Vanguard\Support\Plugins\FinanceDelivery::class,
            \Vanguard\Support\Plugins\Guides::class,
