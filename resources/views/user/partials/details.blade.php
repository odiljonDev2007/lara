<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {!! Form::select('status', $statuses, $edit ? $user->status->value : '',
        ...
        <div class="form-group">
            <label for="abb">@lang('Abb')</label>
            <input type="text" class="form-control input-solid" id="abb"
                   name="abb" placeholder="@lang('Abb')" value="{{ $edit ? $user->abb : '' }}">
        </div>
    </div>
